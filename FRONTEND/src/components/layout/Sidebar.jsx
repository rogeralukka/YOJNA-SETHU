...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    {
      path: "/jan-manch",
      label: t("nav.janManch", "Jan Manch"),
      icon: Megaphone,
      matchPrefix: false
    },
    {
  ...
  return (
    <aside
      className={`h-full shrink-0 z-30 bg-white dark:bg-[#0F1115] border-e-2 border-slate-300 dark:border-white/[0.08] shadow-xs transition-all duration-300 flex flex-col ${
