export const initialUser = {
  ...
  sector: "agriculture",
  sector_other: "",
  agriculture_activity: "Small & Marginal Crop Cultivation (Wheat, Paddy, Mustard)",
  education_level: "Graduate / Bachelor's Degree",
  institution_name: "Banaras Hindu University (BHU)",
  institution_type: "Central University",
  course_program: "B.Sc. Agriculture (Honours)",
  institution_email: "",
