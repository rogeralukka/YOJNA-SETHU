...
export const AddEditSchemeModal = ({ isOpen, onClose, editingScheme = null }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <div className="bg-surface-container-lowest dark:bg-[#0F1115] rounded-3xl max-w-3xl w-full border border-outline-variant/30 dark:border-white/[0.08] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] my-auto animate-fade-in-up">
        {/* Header */}
        <div className="px-6 sm:px-8 py-5 bg-surface-container-low/70 dark:bg-[#16191F]/70 border-b border-surface-container dark:border-white/[0.08] flex items-center justify-between sticky top-0 z-20 backdrop-blur-sm">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full flex items-center justify-center text-on-surface-variant dark:text-[#8A8F98] hover:bg-surface-container dark:hover:bg-[#16191F] transition-colors"
          >
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 overflow-y-auto space-y-6 text-xs">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2 flex flex-col gap-1">
                <label className="font-semibold text-on-surface dark:text-[#EDEDED]">
                  {t('schemeNameLabel')} <span className="text-error">*</span>
                </label>
                <input
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  className="px-3.5 py-2.5 bg-surface-container-low dark:bg-[#16191F] rounded-xl text-on-surface dark:text-[#EDEDED] text-sm border border-outline-variant/40 dark:border-white/[0.08] focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  className="px-3.5 py-2.5 bg-surface-container-low dark:bg-[#16191F] rounded-xl text-on-surface dark:text-[#EDEDED] text-xs border border-outline-variant/40 dark:border-white/[0.08] focus:outline-none focus:ring-2 focus:ring-primary font-semibold cursor-pointer"
                >
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  className="px-3.5 py-2.5 bg-surface-container-low dark:bg-[#16191F] rounded-xl text-on-surface dark:text-[#EDEDED] text-xs border border-outline-variant/40 dark:border-white/[0.08] focus:outline-none focus:ring-2 focus:ring-primary cursor-pointer"
                >
              ...
              <div className="md:col-span-2">
                {governmentLevel === 'central' ? (
                  <div className="p-4 bg-primary/5 dark:bg-primary/10 border border-primary/20 rounded-2xl flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-on-surface dark:text-[#EDEDED] text-xs">
                  ...
                  <div className="flex flex-col gap-3 p-4 bg-surface-container-low dark:bg-[#16191F] rounded-2xl border border-outline-variant/30 dark:border-white/[0.08]">
                    ...
                    {cleanSelectedStates.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 p-2 bg-surface-container-lowest dark:bg-[#08090A] rounded-xl border border-outline-variant/20 dark:border-white/[0.08] max-h-24 overflow-y-auto">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="relative">
                        <Icon name="search" size={16} className="absolute left-2.5 top-1/2 -translate-y-1/2 text-outline dark:text-[#8A8F98]" />
                        <input
                          type="text"
                          value={stateSearch}
                          onChange={(e) => setStateSearch(e.target.value)}
                          placeholder="Search state or union territory..."
                          className="w-full pl-8 pr-3 py-1.5 text-xs bg-surface-container-lowest dark:bg-[#08090A] rounded-xl border border-outline-variant/40 dark:border-white/[0.08] text-on-surface dark:text-[#EDEDED] outline-none focus:ring-2 focus:ring-primary"
                        />
                      </div>

                      <div className="max-h-36 overflow-y-auto p-2 bg-surface-container-lowest dark:bg-[#08090A] rounded-xl border border-outline-variant/20 dark:border-white/[0.08] grid grid-cols-2 sm:grid-cols-3 gap-1.5">
                            ...
                            <button
                              ...
                              className={`px-2.5 py-1.5 rounded-lg text-left text-[11px] font-medium transition-colors flex items-center justify-between gap-1 border ${
                                isChecked
                                  ...
                                  : 'border-outline-variant/20 dark:border-white/[0.08] hover:bg-surface-container-low dark:hover:bg-[#16191F] text-on-surface dark:text-[#8A8F98]'
                              }`}
                            >
              ...
              <div className="md:col-span-2 flex flex-col gap-1">
                ...
                <textarea
                  ...
                  rows={3}
                  className="px-3.5 py-2.5 bg-surface-container-low dark:bg-[#16191F] rounded-xl text-on-surface dark:text-[#EDEDED] text-xs border border-outline-variant/40 dark:border-white/[0.08] focus:outline-none focus:ring-2 focus:ring-primary resize-none placeholder:text-outline-variant dark:placeholder:text-[#8A8F98]/50"
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="px-3.5 py-2.5 bg-surface-container-low dark:bg-[#16191F] rounded-xl text-on-surface dark:text-[#EDEDED] text-xs border border-outline-variant/40 dark:border-white/[0.08]"
                  type="text"
                />
              </div>
          ...
          <div className="p-4 bg-surface-container-low dark:bg-[#16191F] rounded-2xl border border-outline-variant/30 dark:border-white/[0.08] space-y-4">
              ...
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <div className="flex items-center gap-3">
                  <label className="flex items-center gap-1.5 cursor-pointer">
                    ...
                    />
                    <span className="text-on-surface dark:text-[#8A8F98]">Open to All</span>
                  </label>
                  <label className="flex items-center gap-1.5 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      className="text-primary focus:ring-primary"
                    />
                    <span className="text-on-surface dark:text-[#8A8F98]">Specific Statuses</span>
                  </label>
                </div>
              </div>

              {!allLifeStatuses && (
                <div className="p-3 bg-surface-container-lowest dark:bg-[#08090A] rounded-xl border border-outline-variant/20 dark:border-white/[0.08] flex flex-wrap gap-1.5 max-h-36 overflow-y-auto">
                    ...
                    return (
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg text-[11px] font-medium transition-colors border ${
                          isSelected
                            ? 'bg-primary/10 border-primary text-primary dark:text-primary-fixed font-bold'
                            : 'border-outline-variant/30 dark:border-white/[0.08] hover:bg-surface-container dark:hover:bg-[#16191F] text-on-surface-variant dark:text-[#8A8F98]'
                        }`}
                      >
                        {ls.name} {isSelected && '✓'}
                      </button>
            ...
            <div className="space-y-2 pt-3 border-t border-outline-variant/20 dark:border-white/[0.08]">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <label className="font-semibold text-on-surface dark:text-[#EDEDED]">
                  Target Occupations
                </label>
                <div className="flex items-center gap-3">
                  ...
                  <label className="flex items-center gap-1.5 cursor-pointer">
                    <input
                      ...
                      className="text-primary focus:ring-primary"
                    />
                    <span className="text-on-surface dark:text-[#8A8F98]">Specific Occupations</span>
                  </label>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    <input
                      ...
                      className="w-full px-3 py-1.5 text-xs bg-surface-container-lowest dark:bg-[#08090A] rounded-lg border border-outline-variant/40 dark:border-white/[0.08] text-on-surface dark:text-[#EDEDED]"
                    />
                    <select
                      value={eligibleOccupationRequirement}
                      onChange={(e) => setEligibleOccupationRequirement(e.target.value)}
                      className="px-2 py-1.5 bg-surface-container-lowest dark:bg-[#08090A] rounded-lg border border-outline-variant/40 dark:border-white/[0.08] text-on-surface dark:text-[#EDEDED] text-xs whitespace-nowrap cursor-pointer"
                    >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <label className="flex items-center gap-1.5 cursor-pointer">
                    <input
                      ...
                      className="text-primary focus:ring-primary"
                    />
                    <span className="text-on-surface dark:text-[#8A8F98]">Specific Sectors</span>
                  </label>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-end">
                    <select
                      ...
                      className="px-2 py-1.5 bg-surface-container-lowest dark:bg-[#08090A] rounded-lg border border-outline-variant/40 dark:border-white/[0.08] text-on-surface dark:text-[#EDEDED] text-xs cursor-pointer"
                    >
                      <option value="required">Mandatory Requirement</option>
                      <option value="optional">Optional / Higher Priority</option>
                    </select>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-1/2 px-3 py-2 bg-surface-container-low dark:bg-[#16191F] rounded-lg text-on-surface dark:text-[#EDEDED] border border-outline-variant/40 dark:border-white/[0.08]"
                    type="number"
                  />
                  <span>-</span>
                  <input
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="px-3 py-2 bg-surface-container-low dark:bg-[#16191F] rounded-lg text-on-surface dark:text-[#EDEDED] border border-outline-variant/40 dark:border-white/[0.08]"
                  type="number"
                />
              </div>
              ...
              <div className="md:col-span-3 flex items-center gap-2 pt-2">
                ...
                />
                <label htmlFor="business-scheme-toggle" className="font-semibold text-on-surface dark:text-[#EDEDED] cursor-pointer">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-surface-container dark:border-white/[0.08]">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2.5 rounded-xl font-semibold text-on-surface-variant dark:text-[#8A8F98] hover:bg-surface-container dark:hover:bg-[#16191F] transition-colors"
            >
              {t('cancel')}
            </button>
            <button
