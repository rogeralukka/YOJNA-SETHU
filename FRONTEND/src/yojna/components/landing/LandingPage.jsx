  ...
  const slides = [
    {
      ...
      description: t('slide1_desc') || "Your unified gateway to public services, verified document credentials, and national welfare entitlements in one sovereign portal.",
      align: "right",
    ...
    },
    {
      ...
      description: t('slide2_desc') || "Streamline scholarship applications, verified academic credentials, and skill development opportunities with zero friction.",
      align: "left",
    ...
    },
    {
      ...
      description: t('slide3_desc') || "Direct benefit transfers, crop insurance records, and agricultural portal services tailored directly to your land and livelihood.",
      align: "right",
    ...
    },
    {
      ...
      description: t('slide4_desc') || "Healthcare coverage, financial inclusion programs, and household welfare orchestration to empower your independence.",
      align: "left",
    ...
    },
    {
      ...
      description: t('slide5_desc') || "Accelerated business registrations, MSME credit schemes, and federated commercial gateways built to scale your enterprise.",
      align: "right",
    ...
    },
    {
      ...
      description: t('slide6_desc') || "A unified family vault safeguarding pension rights, health benefits, and citizen entitlements across your household's lifetime.",
      align: "left",
