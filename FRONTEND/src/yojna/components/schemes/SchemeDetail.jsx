    ...
    <div className="flex flex-col w-full relative min-h-screen pb-24">
      ...
      <div className="px-4 sm:px-8 lg:px-margin-desktop flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="w-full lg:w-2/3 flex flex-col gap-6">
          {/* Header Card */}
          <div className="bg-surface-container-lowest dark:bg-[#0F1115] rounded-3xl p-6 sm:p-8 shadow-sm border border-outline-variant/30 dark:border-white/[0.08] flex flex-col gap-6">
            <div>
              <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {scheme.governmentLevel === 'state' ? (
                    <span className="px-3 py-1 bg-secondary-container/60 dark:bg-[#16191F] text-on-secondary-container dark:text-[#EDEDED] rounded-full font-status-badge text-xs font-semibold uppercase tracking-wider border border-outline-variant/30 dark:border-white/[0.08]">
                ...
                <span className="px-3 py-1 bg-secondary-container dark:bg-[#16191F] text-on-secondary-container dark:text-[#EDEDED] rounded-full font-status-badge text-xs font-semibold uppercase tracking-wider border dark:border-white/[0.08]">
                  {t('category_' + scheme.category.replace(/ /g, '_'), {}, scheme.category)}
                </span>
              </div>

              <h1 className="font-headline-xl text-2xl sm:text-3xl lg:text-4xl text-on-surface dark:text-[#EDEDED] font-bold mt-2">
                {t('scheme_' + scheme.id, {}, scheme.name)}
              </h1>
              <p className="font-body-lg text-sm sm:text-base text-on-surface-variant dark:text-[#8A8F98] mt-1 max-w-3xl">
                {t('desc_' + scheme.id, {}, scheme.description)}
              </p>
            </div>

            <div className="h-[1px] w-full bg-gradient-to-r from-outline-variant/50 to-transparent dark:from-white/[0.08]" />

            {/* Scheme Overview */}
            <div className="flex flex-col gap-3">
              <h2 className="font-headline-md text-lg font-bold text-on-surface dark:text-[#EDEDED] flex items-center gap-2">
                <span className="text-primary dark:text-primary-fixed flex items-center">
                  <Icon name="description" size={20} />
                </span>
                <span>{t('schemeOverview')}</span>
              </h2>
              <p className="font-body-md text-sm text-on-surface dark:text-[#8A8F98] leading-relaxed">
          ...
          <div className="bg-surface-container-lowest dark:bg-[#0F1115] rounded-3xl p-6 sm:p-8 shadow-sm border border-outline-variant/30 dark:border-white/[0.08] flex flex-col gap-5">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-outline-variant/30 dark:border-white/[0.08] pb-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-on-surface-variant dark:text-[#8A8F98]">
            ...
            <p className="text-xs sm:text-sm text-on-surface dark:text-[#EDEDED] font-medium">
              {evaluation.summary}
            </p>
              ...
              {evaluation.criteriaResults.map((crit, idx) => (
                <div
                  ...
                  className={`p-3 rounded-xl border flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs ${
                    crit.satisfied
                      ? 'bg-emerald-500/5 dark:bg-emerald-950/20 border-emerald-500/20 text-on-surface dark:text-[#EDEDED]'
                      : crit.isMissing
                      ? 'bg-amber-500/5 dark:bg-amber-950/20 border-amber-500/20 text-on-surface dark:text-[#EDEDED]'
                      : 'bg-rose-500/5 dark:bg-rose-950/20 border-rose-500/20 text-on-surface dark:text-[#EDEDED]'
                  }`}
                >
                  <div className="flex items-start gap-2.5">
                    <span
                      className={`shrink-0 mt-0.5 flex items-center ${
                        crit.satisfied
                    ...
                    >
                      <Icon name={crit.satisfied ? 'check_circle' : crit.isMissing ? 'help' : 'cancel'} size={18} />
                    </span>
                    <div>
                  ...
                  <div className="text-right shrink-0 pl-7 sm:pl-0">
                    <span className="text-[10px] text-on-surface-variant dark:text-[#8A8F98] block uppercase font-bold">
                      Required / Your Profile
                    </span>
                    <span className="font-semibold text-xs text-on-surface dark:text-[#EDEDED]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-surface-container-lowest dark:bg-[#0F1115] rounded-2xl p-6 sm:p-8 shadow-sm border border-outline-variant/30 dark:border-white/[0.08] flex flex-col gap-5 relative overflow-hidden group">
              ...
              <h2 className="font-headline-md text-base sm:text-lg font-bold text-on-surface dark:text-[#EDEDED] flex items-center gap-2 relative z-10">
                <span className="text-primary dark:text-primary-fixed flex items-center">
              ...
              <ul className="flex flex-col gap-3 font-body-md text-xs sm:text-sm text-on-surface dark:text-[#8A8F98] relative z-10">
                {scheme.eligibilityCriteria?.map((crit, idx) => (
                  ...
                  >
                    <span
                      className={`shrink-0 mt-0.5 flex items-center ${
                        crit.eligible === false ? 'text-outline dark:text-neutral-500' : 'text-primary dark:text-primary-fixed'
                      }`}
                    >
                      <Icon name={crit.eligible === false ? 'close' : 'done'} size={18} />
                    </span>
            ...
            <div className="bg-surface-container-lowest dark:bg-[#0F1115] rounded-2xl p-6 sm:p-8 shadow-sm border border-outline-variant/30 dark:border-white/[0.08] flex flex-col gap-5 relative overflow-hidden group">
              ...
              <h2 className="font-headline-md text-base sm:text-lg font-bold text-on-surface dark:text-[#EDEDED] flex items-center gap-2 relative z-10">
                <span className="text-tertiary dark:text-tertiary-fixed flex items-center">
              ...
              <ul className="flex flex-col gap-3 font-body-md text-xs sm:text-sm text-on-surface dark:text-[#8A8F98] relative z-10">
                {scheme.documentsRequired?.map((doc, idx) => (
                  <li key={idx} className="flex items-start gap-2.5">
                    <span className="text-tertiary dark:text-tertiary-fixed shrink-0 mt-0.5 flex items-center">
        ...
        <div className="w-full lg:w-1/3 flex flex-col gap-6">
          <div className="bg-surface-container-lowest dark:bg-[#0F1115] rounded-2xl p-6 shadow-sm border border-outline-variant/30 dark:border-white/[0.08] flex flex-col gap-5 sticky top-20">
            ...
            {scheme.isUrgent && (
              <div className="bg-error-container/30 dark:bg-error/20 border border-error/30 p-4 rounded-xl flex items-start gap-3">
                <span className="text-error shrink-0 flex items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-body-sm text-xs text-on-surface dark:text-[#8A8F98] mt-0.5">
            ...
            {/* Benefit Summary */}
            <div className="p-4 bg-surface-container-low dark:bg-[#16191F] rounded-xl border dark:border-white/[0.08]">
              <span className="text-[11px] font-label-bold uppercase tracking-wider text-on-surface-variant dark:text-[#8A8F98]">
                {t('directBenefit')}
              </span>
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full bg-transparent text-secondary dark:text-[#EDEDED] py-3 px-6 rounded-xl font-label-bold text-xs sm:text-sm flex items-center justify-center gap-2 border-2 border-outline-variant dark:border-white/[0.08] hover:bg-surface-container-low dark:hover:bg-[#16191F] transition-colors"
              >
                <Icon
            ...
            {/* Application Stats */}
            <div className="pt-5 border-t border-outline-variant/30 dark:border-white/[0.08] flex flex-col gap-3">
              <h3 className="font-label-bold text-xs uppercase tracking-wider text-on-surface-variant dark:text-[#8A8F98]">
                {t('applicationStats')}
              </h3>
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="font-label-bold font-semibold text-on-surface dark:text-[#EDEDED]">
              ...
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="font-semibold text-on-surface dark:text-[#EDEDED] text-right">
